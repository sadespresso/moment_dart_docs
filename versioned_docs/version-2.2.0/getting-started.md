...
2. Create a moment instance. See [list of constructors](https://pub.dev/documentation/moment_dart/2.2.0/moment_dart/Moment-class.html#constructors)
    ...
    * `Moment.endOfNextIsoWeek()`
    ...
    See [list of static methods](https://pub.dev/documentation/moment_dart/2.2.0/moment_dart/Moment-class.html#static-methods)
